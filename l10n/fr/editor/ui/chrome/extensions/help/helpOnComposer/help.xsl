...
<xsl:template match="/">
  ...
  <div class="contentsBox"><em>Copyright &copy; <xsl:copy-of select="article/artheader/copyright/year"/> <xsl:copy-of select="article/artheader/copyright/holder"/></em></div>
